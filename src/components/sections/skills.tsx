...
const SkillCard = ({ skill, index }: { skill: any; index: number }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative w-[130px] h-28 rounded-xl transition-all duration-300 overflow-hidden",
    ...
    <section id="skills" className="w-full  py-20 ">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-7 gap-1 justify-items-center">
