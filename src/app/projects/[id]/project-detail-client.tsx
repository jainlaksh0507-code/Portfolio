      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex justify-center">
              {project.type === "mobile" ? (
                ...
                // 💻 Desktop view for websites
                <div className="w-full max-w-[600px] rounded-xl overflow-hidden shadow-2xl border bg-black">
                  <video
                    src={project.video}
                    autoPlay
                    muted
        ...
        <div className="mb-12">
          ...
          <div className="flex flex-col md:flex-row md:justify-center items-center gap-8">
            {project.skills.design?.length > 0 && (
              <div className="text-center">
                <p className="text-sm text-muted-foreground mb-4"></p>
                <FloatingDock items={project.skills.design} />
              </div>
            )}
