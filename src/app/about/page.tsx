...
import { background } from "@/components/header/anim";

const CONTACT_LINKS = [
  {
    name: "Email",
    content: "jainlaksh0507@gmail.com",
    href: "mailto:jainlaksh0507@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/laksh0507/",
    content: "/Laksh0507",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/jainlaksh0507-code",
    content: "/jainlaksh0507-code",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              <div className="flex justify-center items-center lg:w-full lg:aspect-square bg-zinc-800 rounded-xl lg:mb-5">
                <img
                  className="rounded-full  object-cover object-top p-3 md:p-4 lg:p-6 xl:p-10 w-[100%] sm:w-[100%] md:w-[100%] lg:w-full max-w-[100%] aspect-square bg-zinc-800"
                  alt="me"
                  src="/assets/laksh-1.jpeg"
                />
              </div>
        ...
        <main className="w-full lg:w-2/3 xl:w-3/4 lg:flex-shrink-0">
          ...
          >
            ...
            <p className="mb-8 md:mb-10 lg:mb-12 text-roboto text-sm md:text-base leading-relaxed">
              Highly motivated UI/UX Designer focused on crafting intuitive, visually appealing and user-centric digital experiences.
              Skilled in transforming ideas into functional designs through research, wireframing and prototyping, while continuously
              striving for usability, consistency and innovation.
            </p>
